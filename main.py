...
class MusicBot:
    ...
    async def setup_and_run_bot(self):
        """Настройка и запуск бота (использует существующий event loop)"""
...
# Запуск бота - ПРОСТОЙ И НАДЕЖНЫЙ ВАРИАНТ
async def main():
    """Основная асинхронная функция"""
    bot = MusicBot()
    await bot.setup_and_run_bot()

if __name__ == '__main__':
    # САМЫЙ ПРОСТОЙ ЗАПУСК - используем существующий event loop
    try:
    ...
    # Запускаем бота в существующем loop
    try:
