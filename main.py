...
class GroupMusicBot:
    ...
    def run(self):
        ...
        # Обработчик сообщений в ГРУППЕ - ТОЛЬКО команды "найди" и "рандом"
        ...
        print('✅ Бот запущен!')
        print('💡 Теперь бот реагирует ТОЛЬКО на команды:')
        print('   • "найди [запрос]" - поиск трека')
